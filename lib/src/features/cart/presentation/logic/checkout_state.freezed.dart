...
mixin _$CheckOutState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(PayResponse response) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(PayResponse response)? success,
...
class _$SuccessImpl implements _Success {
  ...
  @override
  String toString() {
    return 'CheckOutState.success(response: $response)';
  }
...
abstract class _Success implements CheckOutState {
  const factory _Success(final PayResponse response) = _$SuccessImpl;

  PayResponse get response;
